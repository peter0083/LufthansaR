...
Create the following variables "LUFTHANSA_API_CLIENT_ID" and "LUFTHANSA_API_CLIENT_SECRET".

**The name of the variables should be EXACTLY "LUFTHANSA_API_CLIENT_ID" and "LUFTHANSA_API_CLIENT_SECRET"!**

Save your API key and secret in these variables.

```{r, eval=FALSE}

LUFTHANSA_API_CLIENT_ID <- "your API key given by lufthansa Develop Center"

LUFTHANSA_API_CLIENT_SECRET <- "your API secret given by lufthansa Develop Center"

```


Next, get the current token being used by the package.
